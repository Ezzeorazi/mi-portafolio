	...
	const experiences = [
		{
		  ...
		  },
		  {
			...
			startDate: "Mayo 2023",
			endDate: "Julio 2024",
			description: "Desarrollo la interfaz de usuario de 'devsafio.com' utilizando Next.js y Tailwind CSS, con un enfoque en una UX interactiva y de alto rendimiento. Mejoro la interactividad del usuario en el proyecto existente 'SQL Interactivo' de Desafío Latam, implementando funcionalidades con JavaScript avanzado. Facilito la colaboración en equipo mediante el uso eficaz de Figma para diseño, Jira para la gestión de tareas y Discord para la comunicación.",
			technologies: ["Next.js", "Tailwind CSS", "JavaScript", "Figma", "Jira", "Discord"],
		  },
		  {
			id: 3,
